...
Time& Time::setTime(int hour, int minute, int second){
    ...
    return *this; // Enables member functions calls cascading
}

Time& Time::setHour(int hour) { setTime(hour, m_minute, m_second); return *this;}
Time& Time::setMinute(int minute) { setTime(m_hour, minute, m_second); return *this;}
Time& Time::setSecond(int second) { setTime(m_hour, m_minute, second); return *this;}
